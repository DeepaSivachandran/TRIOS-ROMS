    ...
    public partial class INV_InwardPurchaseList : Form
    {
        ...
        public void udfnCmbDropDown()
        {
            try
            {
                ...
                objDataBind.BindComboBoxListSelected("DEF_Status", " STS_ModuleID=13 OR STSID=0 ", "STS_Name,STSID", cmbStatus, "", "STS_Name", "STSID");
        ...
        private void BtnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((grdInwardList.Rows.Count > 0))
                {
                    ...
                    ExcelSheet.Name = "Inward From Purchase,GRN and Purchase DC";
                    int cIndex = 0;
                    int count = 0;
                    foreach (DataGridViewColumn col in grdInwardList.Columns)
                    {
                    ...
                    ExcelSheet.Cells[1, 1].Value = "Inward From Purchase,GRN and Purchase DC";
