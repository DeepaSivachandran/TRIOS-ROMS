...
namespace ROMS
{
    public partial class REPORT_PUR_Tally : Form
    {
        ...
        public void udfnPurchaseTallyReport()
        {
            try
            {
                ...
                objDs = objdserv.udfnPurHsnReport(14, 0, "", 0, dpFromDate.Text, "", 0, 0, 0, 0, 0, Convert.ToInt32(cmbConcern.SelectedValue), 0, 0, 0, 0, 0, 0, 0, "", 0);
