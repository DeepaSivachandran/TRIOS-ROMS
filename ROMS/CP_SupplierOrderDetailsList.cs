...
namespace ROMS
{
    public partial class CP_SupplierOrderDetailsList : Form
    {
        DataValidation objValidation = new DataValidation();
        DataError objError;
        public CP_SupplierOrderDetailsList()
        {
            InitializeComponent();
        }
        ...
        private void tsbNew_Click(object sender, EventArgs e)
        {
            try
            {
                MainForm.objCP_SupplierOrderDetails = new CP_SupplierOrderDetails();
                MainForm.objCP_SupplierOrderDetails.ShowDialog();
            }
            catch (Exception ex)
            {
