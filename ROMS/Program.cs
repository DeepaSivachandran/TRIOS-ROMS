        ...
        public static void Main()
        {
            try
            {
              ...
              //  string path = Application.StartupPath + "\\Server Settings\\serversettings.txt";
                ...
                //{
                //    string versionno = "1.3.1";
                //    string releaseno = objDser.displaydata("SELECT ISNULL(MAX(RLSID),0)+1 FROM TRN_RELEASEDETAILS");
                //    objDser.ExecuteQuery("Insert INTO TRN_RELEASEDETAILS(RLS_ReleaseDate,RLS_VersionNo,RLS_VersionName) VALUES (GETDATE(),'" + versionno + "','" + version + "') ");
                //}
