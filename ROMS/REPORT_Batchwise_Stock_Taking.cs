...
namespace ROMS
{
    public partial class REPORT_Batchwise_Stock_Taking : Form
    {
        ...
        DataError objError;
        CrystalDecisions.CrystalReports.Engine.ReportDocument objBillreport = new CrystalDecisions.CrystalReports.Engine.ReportDocument(); public int varUpDownKeyGroup = 0, varUpDownKeySubgroup = 0, varUpDownKeyProduct = 0, varUpDownKeyBrand = 0, varUpDownKeySupplier = 0, varUpDownKeyLocation = 0;
        private List<ComboItem> months;
        public REPORT_Batchwise_Stock_Taking()
        {
            InitializeComponent();
        ...
        public void udfnProductReport(int varFlag)
        {
            try
            {
                ...
                int varGroupId = 0, varSubgroupId = 0, varBrandId = 0, varSupplierCode = 0, varScheduleCode = 0, varViewType = 0, varParaFlag = 0, varLocationCode = 0,varRowcount=0;
                ...
                {
                                       varRowcount = Convert.ToInt32(txtRowCount.Text.Trim());
                }
                ...
                if (varPrint == 1)
                {
                    ...
                    if (Convert.ToInt32(cmbPrintFormat.SelectedValue) == 359)    // Potrait
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_Batchwise_Stock_TakingSheet_Portrait.rpt");
                    }
                    if (Convert.ToInt32(cmbPrintFormat.SelectedValue) == 360)    // Landscape
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_Batchwise_Stock_TakingSheet.rpt");
                    }
                    // ID Parameters 
                    ...
                    else
                    {
                        ...
                        string varReportName = "Stock Taking";
        ...
        private void REPORT_GRNSummary_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                objDataBind.BindComboBoxListSelected("DEF_Master", "MST_TransactionID IN (189,5,0) AND MSTID NOT IN (-1)", "MST_DisplayText,MSTID", cmbCategory, "", "MST_DisplayText", "MSTID");
                ...
                objDataBind.BindComboBoxListSelected("DEF_Master", "MST_TransactionID=205 ", "MST_DisplayText,MSTID", cmbReportFormat, "", "MST_DisplayText", "MSTID"); 
                objDataBind.BindComboBoxListSelected("DEF_Master", "MST_TransactionID=108 ", "MST_DisplayText,MSTID", cmbPrintFormat, "", "MST_DisplayText", "MSTID");
                objDataBind = null;
        ...
        private void cmbCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (Convert.ToInt32(cmbCategory.SelectedValue) == 625)  //Trading+Child
                {
                    objDataBind.BindComboBoxListSelected("DEF_Master", "MSTID=0 ORDER BY MSTID", "MST_DisplayText,MSTID", cmbType, "", "MST_DisplayText", "MSTID");
                    objDataBind = null;
                    cmbType.Enabled = false;
                }
                else
        ...
        private void txtRowCount_Enter(object sender, EventArgs e)
        {
            try
            {
                udfnGridNull((Control)sender);
                txtRowCount.BackColor = Color.LemonChiffon;
            }
            catch (Exception ex)
            {
                objError = new DataError();
        ...
        private void txtRowCount_Leave(object sender, EventArgs e)
        {
            try
            { 
                txtRowCount.BackColor = Color.White;
            }
            catch (Exception ex)
            {
                objError = new DataError();
