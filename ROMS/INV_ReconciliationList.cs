...
namespace ROMS
{
    public partial class INV_ReconciliationList : Form
    {
        ...
        {
            InitializeComponent();
            windowControl.Initialize(tsStockAdjustment, this);
        }
            ...
            try
            {
                if (varUpDownKeyLocation == 0)
                {
                    ...
                    if (txtStockLocation.Text.Length > 0)
                    {
                        ...
                        objMR_Location.ParaCompanycode = Convert.ToInt32(cmbConcern.SelectedValue);
                        objMR_Location.paraId = 6;
                        objMR_Location.paraLocationName = txtStockLocation.Text.Trim();
                        objMR_Location.ParaFromDate = dtpReconDate.Text;
                        objMR_Location.ParaToDate = dtpReconToDate.Text;
