...
namespace ROMS
{
    public partial class REPORT_PUR_BatchDetails : Form
    {
        ...
        public void udfnPurchaseBatchReport(int varFlag)
        {
            try
            {
                ...
                objDs = objdserv.udfnPurHsnReport("TRNG_Purchase_Reports", 12, Convert.ToInt32(cmbSupplierType.SelectedValue), "", 0, dpFromDate.Text, dpToDate.Text, 0, 0, 0, 0, 0, Convert.ToInt32(cmbConcern.SelectedValue), varSupplierId, varScheduleId, 0, Convert.ToInt32(cmbPaymentType.SelectedValue), Convert.ToInt32(cmbPurchaseType.SelectedValue), Convert.ToInt32(cmbConditionType.SelectedValue), Convert.ToInt32(cmbProductName.SelectedValue), "", "", 0, 0, 0, 0, 0, 0, "");
                ...
                if (varPrint == 1)
                {
                    ...
                    objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_PUR_DET_Batch_Details.rpt");
                    ...
                    objBillreport.SetParameterValue("paraPayType", cmbPaymentType.Text);
                    objBillreport.SetParameterValue("paraConType", cmbConditionType.Text);
                    ...
                    else
                    {
                        ...
                        string varReportName = "PUR_DET_Batch_Details";
