...
namespace ROMS
{
    public partial class REPORT_Stock_Taking : Form
    {
        ...
        public void udfnProductReport(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_TP_Stock_Taking.rpt");
                    }
