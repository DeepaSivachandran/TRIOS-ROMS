...
namespace ROMS
{
    public partial class REPORT_CP_Product_Weight : Form
    {
        ...
        public REPORT_CP_Product_Weight()
        {
            InitializeComponent();
        ...
        public void udfnProductCategoryReport(int varFlag)
        {
            ...
            {
                epReport.Clear();
                string varGroupName = "-All-", varSubgroupName = "-All-", varBrandName = "-All-",varLocationName="-All-";
                int varGroupId = 0, varSubgroupId = 0, varBrandId = 0,varLocationID=0;
                ...
                objMR_ProductReport.paraLocationId = varLocationID;
                objMR_ProductReport.paraProductCategory = Convert.ToInt32(cmbCategory.SelectedValue);
                objMR_ProductReport.paraProductType = Convert.ToInt32(cmbType.SelectedValue);
                ...
                if (varPrint == 1)
                {
                    ...
                    if (Convert.ToInt32(cmbReportType.SelectedValue) == 492) //Locationwise weight
                    { 
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_CP_ProductWeight_LocationWise.rpt");
                    }
                    else if (Convert.ToInt32(cmbReportType.SelectedValue) == 493) //Locationwise Product Group Weight  Report
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_CP_ProductWeight_LocationWiseGroup.rpt");
                    }
                    else if (Convert.ToInt32(cmbReportType.SelectedValue) == 494) //Locationwise Product subgroup Weight  Report
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_CP_ProductWeight_LocationWiseSubgroup.rpt");
                    }
                    else if (Convert.ToInt32(cmbReportType.SelectedValue) == 495) //Locationwise Product Weight  Detail Report
                    {
                    ...
                    objBillreport.SetParameterValue("paraProCategory", Convert.ToInt16(cmbCategory.SelectedValue));
                    objBillreport.SetParameterValue("paraCategoryName", Convert.ToString(cmbType.Text));
                    ...
                    objBillreport.SetParameterValue("paraLocationId", varLocationID);
                    objBillreport.SetParameterValue("paraProductCategory", Convert.ToInt16(cmbCategory.SelectedValue));
                    objBillreport.SetParameterValue("paraProductType", Convert.ToInt16(cmbType.SelectedValue)); 
