        ...
        private void udfnEdit()
        {
            try
            {
                ...
                if (grdHSNList.SelectedRows.Count > 0)
                {
                    ...
                    MainForm.objCP_Brand.varbrandcode = grdHSNList.SelectedRows[0].Cells["BrandCode"].Value.ToString();
                ...
                if (objDs != null)
                {
                    if (objDs.Tables.Count != 0)
                    {
                        ...
                        if (objDs.Tables[0].Rows.Count != 0)
                        {
                            ...
                            grdHSNList.Columns[1].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                            grdHSNList.Columns["Total No. of FG"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            grdHSNList.Columns["Brand Name in Tamil"].Width = 275;
                            grdHSNList.Columns["Brand Name in English"].Width = 275;
                            grdHSNList.Columns["Label Name in Tamil"].Width = 275;
                            grdHSNList.Columns["Label Name in English"].Width = 275;
                            grdHSNList.Columns["BrandCode"].Visible = false;
                        }
                        else
                        {
            ...
            try
            {
                for (int i = 0; i < DGV_SearchGrid.Rows.Count; ++i)
                {
                    if (DGV_SearchGrid.ColumnCount > 0)
                    {
                        ...
                        bs.DataSource = grdHSNList.DataSource;
                        string filter = "";
