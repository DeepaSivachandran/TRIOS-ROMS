    ...
    public partial class REPORT_Stock_Inward : Form
    {
        ...
        public void udfnStockInwardReport()
        {
            try
            {
                ...
                objDs = objdserv.udfnGrnListLoad(16, Convert.ToInt32(lblSupplierCode.Text), Convert.ToInt32(lblschedleCode.Text), 0, 0, dpFromDate.Text, dpToDate.Text, 0, 0, 0, "", "", varProductId, 0, "0", "", "", 0, varGroupId, varSubgroupId, 0);
