...
namespace ROMS
{
    public partial class CP_RackSetting : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                errRackSetting.Clear();
                if (txtSupplier.Text.Trim() == "")
                {
                    errRackSetting.SetError(txtSupplier, "Please enter group english name");
                    txtSupplier.BackColor = System.Drawing.ColorTranslator.FromHtml("#fabdbd");

                    tpegroupname.ShowAlways = true;
                    tpegroupname.Show("Please enter group english name", txtSupplier, 5000);
                    txtSupplier.Text = "";
        ...
        private void txtEGroupNameEnglish_Leave(object sender, EventArgs e)
        {
            ...
            //    if (txtSupplier.Text == "")
            //    {
            //        txtSupplier.BackColor = ColorTranslator.FromHtml("#fabdbd");
            //        errSupplierMapping.SetError(txtSupplier, "Please Enter Group Name In English");
            //    }
            //    else
            //    {
            //        txtSupplier.BackColor = Color.White;
            //        errSupplierMapping.Clear();
            //    }
            //}
            //catch (Exception ex)
            //{
        ...
        private void TxtEGroupNameTamil_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                //    errSupplierMapping.SetError(txtEGroupNameTamil, "Please Enter Group Name in Tamil");
                //}
                //else
                //{
        ...
        private void TxtEGroupNameTamil_TextChanged(object sender, EventArgs e)
        {

        }

        private void TxtDEGroupNameEnglish_TextChanged(object sender, EventArgs e)
        {
