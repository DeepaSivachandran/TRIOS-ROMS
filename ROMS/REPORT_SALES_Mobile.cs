...
namespace ROMS
{
    public partial class REPORT_SALES_Mobile : Form
    {
        ...
        public REPORT_SALES_Mobile()
        {
            InitializeComponent();
            this.DoubleBuffered = true;
            windowControl.Initialize(tpMobileReport, this);
        }
        ...
        public void udfnMobile()
        {
            try
            {
                ...
                objMR_Sales.paraProviderId = Convert.ToInt32(cmbVendor.SelectedValue);
                ...
                if (varPrint == 1)
                {
                    ...
                    objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_SALES_Mobile.rpt");
                    objBillreport.SetParameterValue("paraStatusName", Convert.ToString(cmbStatus.Text));
                    objBillreport.SetParameterValue("paraStatusId", Convert.ToInt32(cmbStatus.SelectedValue));
                    objBillreport.SetParameterValue("paraVendorName", Convert.ToString(cmbVendor.Text));
                    objBillreport.SetParameterValue("paraProviderId", Convert.ToInt32(cmbVendor.SelectedValue));
        ...
        private void REPORT_CP_Mobile_Load(object sender, EventArgs e)
        {
            try
            {
                dynamicLabelControl.PlaceholderLabel = tsLabelPlaceholder;
                int currentMUCode = 140206;
                ...
                objDataBind.BindComboBoxListSelected("DEF_Master", "MST_TransactionID in (0,137) AND MSTID<>-1 ORDER BY MSTID ASC", "MST_DisplayText,MSTID", cmbVendor, "", "MST_DisplayText", "MSTID");
                objDataBind = null;
        ...
        private void REPORT_CP_Mobile_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
