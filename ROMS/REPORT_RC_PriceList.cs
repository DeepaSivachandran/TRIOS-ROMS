...
namespace ROMS
{
    public partial class REPORT_RC_PriceList : Form
    {
        ...
        { 
            ...
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_RC_PriceList.rpt");
