...
namespace ROMS
{
    public partial class REPORT_PUR_ProductWiseLastPurchase : Form
    {
        ...
        public void udfnLastPurchaseReport(int varFlag)
        {
            try
            {
                ...
                objDs = objdserv.udfnPurHsnReport(10, 0, "", 0, "", "", varProductId, varGroupId, varSubgroupId, Convert.ToInt32(cmbLPDates.Text), varBrandId, Convert.ToInt32(cmbConcern.SelectedValue), varSupplierId, varScheduleId, 0, 0, 0, 0, Convert.ToInt32(cmbProductName.SelectedValue), txtSearchByPICode.Text.Trim(), "", 0, 0, 0, 0, 0, 0, "");
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "PUR_DET_ProductWise_Last_Purchased";
