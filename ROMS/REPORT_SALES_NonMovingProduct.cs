...
namespace ROMS
{
    public partial class REPORT_SALES_NonMovingProduct : Form
    {
        ...
        public REPORT_SALES_NonMovingProduct()
        {
            InitializeComponent();
        ...
        private void BtnListPrint_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                {
                    epReport.SetError(txtDays, "Please enter days.");
                    txtDays.BackColor = System.Drawing.ColorTranslator.FromHtml("#fabdbd");
                    tpSupplier.ShowAlways = true;
                    tpSupplier.Show("Please enter days.", txtDays, 5000);
                    txtDays.Focus();
                    return;
                }
                epReport.Clear();
        ...
        public void udfnProductCategoryReport(int varFlag)
        {
            try
            {
                ...
                string varCategoryTypeName = "-All-";
                ...
                if (!string.IsNullOrWhiteSpace(txtProductName.Text))
                {
                    ...
                    int.TryParse(lblProduct.Text.Trim(), out varProductCode);
                }
                ...
                if (!string.IsNullOrWhiteSpace(cmbType.Text))
                    varCategoryTypeName = cmbType.Text.Trim();
                ...
                int varDays = 0;
                int.TryParse(txtDays.Text.Trim(), out varDays);
                ...
                objMR_Sales.paraType = varCategoryType;
                objMR_Sales.paraSubgroupType = varSubgroupType;
                objMR_Sales.paraOrderby = varOrderType;
                objMR_Sales.paraPicode = varPicode; 
                objMR_Sales.paraConcernId = Convert.ToInt32(cmbConcern.SelectedValue);

                objMR_Sales.paraDays = Convert.ToString(varDays);
                ...
                if (varPrint == 1)
                {
                    ...
                    if (Convert.ToInt32(cmbReportType.SelectedValue) == 670)
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_SALES_NonMovingProSales.rpt");
                    }
                    else if (Convert.ToInt32(cmbReportType.SelectedValue) == 671)
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_SALES_NonMovingProLastSales.rpt");
                    }
    ...
    varDays);
                        ...
                        objBillreport.SetParameterValue(
    "paraOrderby",
    Convert.ToInt32(cmbOrderType.SelectedValue));
