    ...
    public partial class REPORT_Unapproved_Purchase_Detail : Form
    {
        ...
        public void udfnList(int varFlag)
        {
            try
            {
                ...
                udfnUnapprovedPurchaseDetails(varFlag);
        ...
        public void ExportPurchaseJsonToExcelInterop(string jsonString, string fromDate, string supplierName, string payType, string conditionType)
        {
            ...
            try
            {
                ...
                foreach (var purchase in purchases)
                {
                    ...
                    sheet.Cells[row + 1, 25] = header["Status"];
                ...
                SaveFileDialog sfd = new SaveFileDialog
                {
                    ...
                    FileName = "Unapproved Purchase Details Report" + " _ " + dpFromDate.Text.Replace("/", "-") + "_" + dpToDate.Text.Replace("/", "-") + ".xlsx"
                };
        ...
        public void udfnUnapprovedPurchaseDetails(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "Unapproved_Purchase_Details";
