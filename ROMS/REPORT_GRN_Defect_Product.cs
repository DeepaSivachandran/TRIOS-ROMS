...
namespace ROMS
{
    public partial class REPORT_GRN_Defect_Product : Form
    {
        ...
        {
            InitializeComponent();
            windowControl.Initialize(tsGRNDefectProductReport, this);
        }
        ...
        public void udfnGRNDefect(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "GRN_Defect_Product";
