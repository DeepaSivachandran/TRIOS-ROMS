...
namespace ROMS
{
    public partial class REPORT_StockVsZeroRate : Form
    {
        ...
        public REPORT_StockVsZeroRate()
        {
            InitializeComponent();
            windowControl.Initialize(tsStockZeroRateReport, this);
        }
        ...
        public void udfnStockVsZeroRateReport(int varFlag)
        {
            try
            {
                string varLocationName = "-All-";
                int varLocationId = 0;
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "StockVsZeroRate";
