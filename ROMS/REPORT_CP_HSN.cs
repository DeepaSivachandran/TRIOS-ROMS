        ...
        private void REPORT_CP_HSN_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                udfnHsnLoad();
                    ...
                    string ReportTyprIDs = string.Join(",",
                    MainForm. objDtMenuDetailsUser? .AsEnumerable()
                        .Where(r => r.Field<int?>("MU_ParentMenuCode") == 80104) 
                ...
                objDataBind.BindComboBoxListSelected("DEF_MASTER", "MST_TransactionID IN (0,35) AND MSTID<>0 AND MSTID IN ("+ ReportTyprIDs + ")", "MST_DisplayText,MSTID,MST_ShortName", cmbReportType, "", "MST_DisplayText", "MSTID");
