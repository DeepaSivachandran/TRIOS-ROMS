        ...
        private void udfnEdit()
        {
            try
            {
                ...
                if (grdRackSettingList.SelectedRows.Count > 0)
                {
                    ...
                    MainForm.objCP_Brand.varbrandcode = grdRackSettingList.SelectedRows[0].Cells["BrandCode"].Value.ToString();
                ...
                if (objDs != null)
                {
                    if (objDs.Tables.Count != 0)
                    {
                        ...
                        if (objDs.Tables[0].Rows.Count != 0)
                        {
                            ...
                            grdRackSettingList.Columns[1].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
                            grdRackSettingList.Columns["Total No. of FG"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            grdRackSettingList.Columns["Brand Name in Tamil"].Width = 275;
                            grdRackSettingList.Columns["Brand Name in English"].Width = 275;
                            grdRackSettingList.Columns["Label Name in Tamil"].Width = 275;
                            grdRackSettingList.Columns["Label Name in English"].Width = 275;
                            grdRackSettingList.Columns["BrandCode"].Visible = false;
                        }
                        else
                        {
