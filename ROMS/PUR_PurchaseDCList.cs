        ...
        private void AdjustFormSize()
        {
            try
            {
                ...
                if (Convert.ToInt32(screen.WorkingArea.Width) >= 1366)
                {
                    ...
                    varPercentage = objValidation.udfhScreenResolution(pnlcity, this);
                    ...
                    varIncreaseWidthSize = pnlcity.Width + (pnlcity.Width * varPercentageWidth / 100);
                    varIncreaseHeightSize = pnlcity.Height + (pnlcity.Height * varPercentageHeight / 100);
                    ...
                    if (Convert.ToInt32(screen.WorkingArea.Width) == 1366)
                    {
                        grdPurchaseDCList.Size = new Size(this.grdPurchaseDCList.Width, this.grdPurchaseDCList.Height);
                    ...
                    else
                    {
                            ...
                            if (controls is GroupBox)
                            {
                                foreach (Control control1 in controls.Controls)
                                {
                                    ...
                                    else
                                    {
                                        varIncreaseWidthSize = control1.Width + (control1.Width * varPercentageWidth / 100);
                                        varIncreaseHeightSize = control1.Height + (control1.Height * varPercentageHeight / 100);
                                        control1.Size = new Size(Convert.ToInt32(varIncreaseWidthSize), control1.Height+Convert.ToInt32(FontSize-4));
                                    }
                        ...
                        label12.Location = new Point(label12.Location.X, label12.Location.Y + Convert.ToInt32(FontSize));
                        foreach (Control controlsss in usedControls)
                        {
                            if (controlsss is ComboBox || controlsss is TextBox || controlsss is DateTimePicker || controlsss is Button || controlsss is Label)
                            {
                                ...
                                {
                                    controlsss.Location = new Point(varIniLoct, controlsss.Location.Y + Convert.ToInt32(FontSize));
                                }
                                varIniLoct = controlsss.Location.X + 6 + controlsss.Width;
                            }
                        }
                        grdPurchaseDCList.DefaultCellStyle.Font = new Font("Oswald Regular", Convert.ToInt32(FontSize));
                        ...
                        grdPurchaseDCList.RowTemplate.Height = Convert.ToInt32(FontSize + 2) * 2;
                    ...
                    grdPurchaseDCList.Location = new Point(grdPurchaseDCList.Location.X, (grbFilterBy.Height + DGV_SearchGrid.Height + 5));
