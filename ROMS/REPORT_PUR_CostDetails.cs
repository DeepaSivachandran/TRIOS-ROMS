...
namespace ROMS
{
    public partial class REPORT_PUR_CostDetails : Form
    {
        ...
        {
            InitializeComponent();
            windowControl.Initialize(tsCostDetailsReport, this);
        }
        ...
        public void udfnList(int varFlag)
        {
            try
            {
                ...
                else
                {
                    ...
                    udfnPurchaseCostDetailsReport(varFlag);
                }
            }
            catch (Exception ex)
            {
        ...
        public void udfnPurchaseCostDetailsReport(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_PUR_DET_Cost_Details.rpt");
                    ...
                    else
                    {
                        ...
                        string varReportName = "PUR_DET_Cost_Details";
