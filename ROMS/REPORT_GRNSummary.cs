...
namespace ROMS
{
    public partial class REPORT_GRNSummary : Form
    {
        ...
        public void udfnGRNSummary(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "GRNSummary";
        ...
        private void REPORT_GRNSummary_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                int currentMUCode = 80204;
                dynamicLabelControl.BindMenuHierarchy(currentMUCode);
                DataBind objDataBind = new DataBind();
                objDataBind.BindComboBoxListSelected("DEF_Status", "STS_ModuleID IN (0,7) AND STSID IN (0,17,23,44)", "STS_Name,STSID", cmbStatus, "", "STS_Name", "STSID");
                objDataBind = null;
                udfnConcernLoad();
