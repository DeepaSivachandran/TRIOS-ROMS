    ...
    public partial class REPORT_Unapproved_Purchase_Summary : Form
    {
        ...
        public void udfnList(int varFlag)
        {
            try
            {
                ...
                udfnUnapprovePurchaseSummary(varFlag);
            }
            catch (Exception ex)
            {
                objError = new DataError();
        ...
        public void udfnUnapprovePurchaseSummary(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "Unapproved_Purchase_Summary";
