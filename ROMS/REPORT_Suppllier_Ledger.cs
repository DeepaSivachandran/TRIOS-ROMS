...
namespace ROMS
{
    public partial class REPORT_Suppllier_Ledger : Form
    {
        ...
        {
            InitializeComponent();
            windowControl.Initialize(tsLedgerReport, this);
        }
        ...
        public void udfnSupplierLedger(int varFlag)
        {
            try
            {
        ...
        private void REPORT_GRN_Defect_Product_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DataBind objDataBind = new DataBind(); //Transaction id 	86
