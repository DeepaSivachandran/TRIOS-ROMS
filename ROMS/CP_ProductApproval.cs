    ...
    public partial class CP_ProductApproval : Form
    {
        ...
        private void TxtPurLocation_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objDs = objspdservice.udfnStockLocationList(10, Convert.ToInt32(varComId), 0, 0, txtPurLocation.Text.Trim(), 0, 0, 0, "", "");
                    objspdservice.CloseConnection();
                    if (objDs != null)
                    {
                        if (objDs.Tables.Count != 0)
        ...
        private void TxtSalesLocation_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objDs = objspdservice.udfnStockLocationList(10, Convert.ToInt32(varComId), 0, 0, txtSalesLocation.Text.Trim(), 0, 0, 0, "", "");
                    objspdservice.CloseConnection();
                    if (objDs != null)
                    {
                        if (objDs.Tables.Count != 0)
        ...
        public void udfnUpdate()
        {
            try
            {
                ...
                if (txtSalesLocation.Text != "")
                {
                    ...
                    objDsSalesLoc = objDServ5.udfnStockLocationList(14, 0, 0, 0, txtSalesLocation.Text.Trim(), 0, 0, 0, "", "");
                    ...
                    if (Convert.ToString(txtSalesRack.Text) != "" && Convert.ToString(txtSalesRack.Text) != "None")
                    {
                        ...
                        objDsSalesRack = objDServ7.udfnRackList(17, 0, 0, Convert.ToInt32(varSalesLocationCode), 0, txtSalesRack.Text.Trim(), 0, 0);
                    ...
                    if (blnErrorFlag == false)
                    {
                        ...
                        Convert.ToInt32(cmbPeriod.SelectedValue), varStatus, MainForm.pbUserID, MainForm.pbIpAddress, varorignator, 0, null, 0, "");
