        ...
        private void AdjustFormSize()
        {
            try
            {
                ...
                if (Convert.ToInt32(screen.WorkingArea.Width) >= 1366)
                {
                    ...
                    if (Convert.ToInt32(screen.WorkingArea.Width) == 1366)
                    {
                        grdPurchaseEntryRejected.Size = new Size(this.grdPurchaseEntryRejected.Width, this.grdPurchaseEntryRejected.Height);
                    ...
                    else
                    {
                        ...
                        grdPurchaseEntryRejected.DefaultCellStyle.Font = new Font("Oswald Regular", Convert.ToInt32(FontSize));
                        ...
                        grdPurchaseEntryRejected.RowTemplate.Height = Convert.ToInt32(FontSize + 2) * 2;
                    ...
                    grdPurchaseEntryRejected.Location = new Point(grdPurchaseEntryRejected.Location.X, (grpfilter.Height + DGV_SearchGrid.Height + 5));
