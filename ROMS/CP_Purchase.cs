        ...
        private void GrdSupplierList_CellValueChanged(object sender, DataGridViewCellEventArgs e)
       {
        ...
        public void udfnAddProductsgrid()
        {
            try
            {
                ...
                if(Convert.ToInt16(cmbQtyType.SelectedValue)==193 || Convert.ToInt16(cmbQtyType.SelectedValue) == 194 ||  Convert.ToInt16(cmbQtyType.SelectedValue) == 226 ||
                    Convert.ToInt16(cmbQtyType.SelectedValue) == 255 || Convert.ToInt16(cmbQtyType.SelectedValue) == 257 || Convert.ToInt16(cmbQtyType.SelectedValue) == 227)
                {
                    ...
                    if (Convert.ToInt32(lblSupplierCode.Text) != 0)
                    {
                        if (varflag == 0)
                        {
                            ...
                            if (pbDateflag == 0 && varerrFlag == 0)
                            {
                                ...
                                grdSupplierList.Rows.Add(maxSno + 1,null, /*(varpono[0]).Trim(),*/varPurProductType,"",(varPICode).Trim(), (varTName).Trim(), (var_Symbol).Trim(), Convert.ToString(cmbQtyType.Text) ,
                        ...
                        for (int i = 0; i < grdPurchaseList.Rows.Count; i++)
                        {
                            ...
                            if ((varEntryType == 56 || varEntryType == 55) && (Convert.ToString(grdPurchaseList.Rows[i].Cells["clmGRNProType"].Value) != "226"))  //Direct and against po
                            {
                                    ...
                                    && Convert.ToDecimal(grdPurchaseList.Rows[i].Cells["clmInvQty"].Value) != 0 && varConvertProductFlag=="0"))
                                {
                                    ...
                                    if(varRecqty==0)
                                    { varerrFlag = 1; }
                                    if ((varDiffQty != varQty || (varInvqty + varFreeQuantity) != (varRecqty + varDiffQty   )) && varConvertProductFlag=="0")
                                    {
                                        varcount++; varQuantityErr++; varerrFlag = 1;
                                    }
                                    if (varerrFlag == 1)
                        ...
                        if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmexpirydate"].Value) != "0" || Convert.ToString(grdSupplierList.Rows[i].Cells["clmexpirydate"].Value) == "")
                        {
                            ...
                            //{
                                ...
                                { 
                                    ...
                                    {
                                        if (Convert.ToString(grdSupplierList.Rows[i].Cells["slid"].Value) == "-1" && varProConditionType != "226")
                                        {
                                            varcount++; varCount2++;
                                    ...
                                    {
                                        if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmexpirydate"].Value) == "" && varProConditionType != "226")
                                        {
                                            varcount++; varCount2++;
                                            grdSupplierList.Rows[i].Cells["clmexpirydate"].Style.BackColor = Color.LightPink;
                                        }
        ...
        private void CmbQtyType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToInt32(cmbQtyType.SelectedValue) == 193 || Convert.ToInt32(cmbQtyType.SelectedValue) == 194 || Convert.ToInt32(cmbQtyType.SelectedValue) == 227 
                    || Convert.ToInt32(cmbQtyType.SelectedValue) == 255 || Convert.ToInt32(cmbQtyType.SelectedValue) == 226 || Convert.ToInt32(cmbQtyType.SelectedValue) == 257)
                {
                ...
                if (txtProductName.Text != "")
                {
                    ...
                    { 
                        ...
                        if (Convert.ToInt32(cmbPONo.SelectedValue) == 218) //GRN
                        {
                            ...
                            txtInvoiceQty.Text = Convert.ToString(DGV_FilterProduct.SelectedRows[0].Cells["Mismatch Qty"].Value);
