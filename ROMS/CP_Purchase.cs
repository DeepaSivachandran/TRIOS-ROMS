                    ...
                    switch (grdSupplierList.Columns[e.ColumnIndex].Name)
                    {
                        ...
                        case "clmRemove":
                            ...
                            if (dialogResult == DialogResult.Yes)
                            {
                                ...
                                if (Convert.ToString(grdSupplierList.Rows[e.RowIndex].Cells["clmid"].Value) == "218" || Convert.ToString(grdSupplierList.Rows[e.RowIndex].Cells["clmid"].Value) == "220") //GRn,dc
                                {
                                    var varRemoveProuct =
            ...
            try
            {
                if (Convert.ToInt32(lblProductcode.Text) != 0)
                {
                    ...
                    if (Convert.ToInt32(varPrcategory) == 16 && varShelflife == 1 && Convert.ToString(cmbPONo.SelectedValue)!="220") //entry type not against dc
                    {
                        ...
                        {
                            objDs = objspdservice.udfnMaster(15, 0, 0, vardate, "", Convert.ToInt32(lblProductcode.Text), "", 0);
                            objspdservice.CloseConnection();
                            if (objDs.Tables[0] != null)
                            {
                                if (objDs.Tables[0].Rows.Count != 0)
