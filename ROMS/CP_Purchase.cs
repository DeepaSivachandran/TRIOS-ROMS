    ...
    public partial class CP_Purchase : Form
    {
        ...
        public void udfnVerifyEnable()
        {
            try
            {
                ...
                if (Convert.ToString(cmbEntryType.SelectedValue) == "544")//GRN
                {
        ...
        public void udfnAddProductsgrid()
        {
            try
            {
                ...
                if (varGRNProType != "226" || varGrnType=="214" || varProCondition=="214" || varProCondition == "217" || varProCondition == "219")
                {
                ...
                if(Convert.ToInt16(cmbQtyType.SelectedValue)==193 || Convert.ToInt16(cmbQtyType.SelectedValue) == 194 || Convert.ToInt16(cmbQtyType.SelectedValue) == 255)
                {
                    if (txtInvoiceQty.Text.Trim() == "" && varQuantityType != "226")
                    {
                        errPurchaseentry.SetError(txtInvoiceQty, "Please enter quantity");
                ...
                /*check location have a rack or not*/
                if (varRMFlag != 59 && Convert.ToString(cmbPONo.SelectedValue) != "220" && varGRNProType != "226" || varGrnType == "214" || varProCondition == "214" || varProCondition == "217" || varProCondition == "219") 
                {
                    string varId_PurchaseRack = "0";
                ...
                if ((varGRNProType != "226" || varGrnType == "214" || varProCondition == "214" || varProCondition == "217" || varProCondition == "219")  && varQuantityType != "226")
                {
                    if (varShelflife == 1)
                    {
                        if (txtMonth.Text.Trim() == "")
                ...
                if (varErrorFlag == false)
                {
                    ...
                    if (varGRNProType != "226" || varGrnType == "214" || varProCondition == "214" || varProCondition == "217" || varProCondition == "219")
                    {
                        if (expirydateFlag == 1 && (txtDate.Text != "" || txtMonth.Text != "" || txtYear.Text != "") && varQuantityType!="226")
                        {
                    ...
                    if (Convert.ToInt32(lblSupplierCode.Text) != 0)
                    {
                        if (varflag == 0)
                        {
                            ...
                            if (pbDateflag == 0 && varerrFlag == 0)
                            {
                                ...
                                decimal varGrnMrp = 0;
                                string varExcessQty ="0",varPendingQty="0" , varDamageQty="0";int invFlag = 0;
                                ...
                                if (Convert.ToInt16(cmbQtyType.SelectedValue) == 193)
                                {
                                    if (Convert.ToString(txtInvoiceQty.Text.Trim()) != "")
                                    { varPendingQty = Convert.ToString(txtInvoiceQty.Text); }
                                }
                                if(Convert.ToInt16(cmbQtyType.SelectedValue) == 194)
                                {
                                    if (Convert.ToString(txtInvoiceQty.Text.Trim()) != "")
                                    { varExcessQty = Convert.ToString(txtInvoiceQty.Text); }
                                }
                                if(Convert.ToInt16(cmbQtyType.SelectedValue) == 255)
                                {
                                    if (Convert.ToString(txtInvoiceQty.Text.Trim()) != "")
                                    { varDamageQty = Convert.ToString(txtInvoiceQty.Text); }
                                }
                                grdSupplierList.Rows.Add(maxSno + 1,null, /*(varpono[0]).Trim(),*/varPurProductType,(varPICode).Trim(), (varTName).Trim(), (var_Symbol).Trim(), Convert.ToString(cmbQtyType.Text) ,varPendingQty,varExcessQty, varDamageQty, varGrnMrp, (txtMrp.Text).Trim(), varProMrp,(varExpiryDateAdd).Trim()
                                ...
                                if(Convert.ToString(cmbQtyType.SelectedValue)=="193")
                                {
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmExcessQty"].ReadOnly = true;
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmExcessQty"].Style.BackColor = Color.LightGray;
                                ...
                                else if (Convert.ToString(cmbQtyType.SelectedValue) == "194")
                                {
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmPendingQty"].ReadOnly = true;
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmPendingQty"].Style.BackColor = Color.LightGray;
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmDamageQty"].ReadOnly = true;
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmDamageQty"].Style.BackColor = Color.LightGray;
                                }
                                else if (Convert.ToString(Convert.ToString(cmbQtyType.SelectedValue)) == "255")//Damage
                                {
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmExcessQty"].ReadOnly = true;
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmExcessQty"].Style.BackColor = Color.LightGray;
                                    grdSupplierList.Rows[grdSupplierList.RowCount - 1].Cells["clmPendingQty"].ReadOnly = true;
        ...
        public void udfnrowclear()
        {
            try
            {
                ...
                cmbrack.DataSource = null;
                txtGRNMrp.Text="";
                //if(Convert.ToString(cmbEntryType.SelectedValue)=="54" || Convert.ToString(cmbEntryType.SelectedValue) == "57")
                //{
                //cmbQtyType.Enabled = false;
                //txtInvoiceQty.Enabled = false;
                //txtInvoiceQty.ReadOnly = true;
                //}
                //else
                //{
                ...
                if (pbPurchaseno != "0")
                {
                    ...
                    if (grdPurchaseList.Rows.Count != 0)
                    {
                        for (int i = 0; i < grdPurchaseList.Rows.Count; i++)
                        {
                            ...
                            if (Convert.ToInt32(cmbEntryType.SelectedValue) == 57 &&  (Convert.ToString(grdPurchaseList.Rows[i].Cells["clmGRNProType"].Value) != "226"))  //Against DC
                            {
                                ...
                                if ( Convert.ToString(grdPurchaseList.Rows[i].Cells["clmRecqty"].Value) != "" &&
                                    ...
                                    Convert.ToDecimal(grdPurchaseList.Rows[i].Cells["clmInvQty"].Value) != 0
                                    && varConvertProductFlag!="0"))
                                {
                            ...
                            if ((varEntryType == 56 || varEntryType == 55) && (Convert.ToString(grdPurchaseList.Rows[i].Cells["clmGRNProType"].Value) != "226"))  //Direct and against po
                            {
                                if ( Convert.ToString(grdPurchaseList.Rows[i].Cells["clmRecqty"].Value) != "" &&
                                    Convert.ToDecimal(grdPurchaseList.Rows[i].Cells["clmRecqty"].Value) != 0 ||(Convert.ToString(grdPurchaseList.Rows[i].Cells["clmInvQty"].Value) != ""  
                                    && Convert.ToDecimal(grdPurchaseList.Rows[i].Cells["clmInvQty"].Value) != 0 && varConvertProductFlag=="0"))
                                {
                                    ...
                                    //if (varFlag == 1)
                                    //{
                                    //    if (varInvqty != (varRecqty + varFreeQuantity+varDiffQty) || varDiffQty != varQty)
                                    //    {
                                    //        varcount++; varQuantityErr++; varerrFlag = 1;
                                    //    }
                                    //}
                            ...
                            if (varEntryType == 54 && (Convert.ToString(grdPurchaseList.Rows[i].Cells["clmGRNProType"].Value) != "226")) //  GRN
                            {
            ...
            try
            {
                ...
                if (tbDetails.TabPages[0].Enabled == true)
                {
                    ...
                    for (int i = 0; i < grdSupplierList.Rows.Count; i++)
                    {
                        ...
                        {
                            decimal varMRP = 0, varGrnMRP = 0; decimal varShelfPer = 0 , varExcessQty=0 , varPendingQty=0 , varDamageQty = 0; varTempExpiryDate = ""; int varConvertProduct = 0;
                            ...
                            varProConditionType = Convert.ToString(grdSupplierList.Rows[i].Cells["clmGRNProductType"].Value);
                            if ( Convert.ToString(grdSupplierList.Rows[i].Cells["clmGRNType"].Value) == "214")
                            {
                                ...
                                { 
                                    ...
                                    if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmLocation"].Value) != "" && varProConditionType != "226")
                                    {
                                    ...
                                    if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmShelflifeenable"].Value) == "1" && varProConditionType != "226")
                                    {
                                    ...
                                    {
                                        if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmBatchno"].Value) == "" && varProConditionType != "226")
                                        {
                                            varcount++; varCount2++;
                                    ...
                                    {
                                        if ((Convert.ToString(grdSupplierList.Rows[i].Cells["clmMRP"].Value) == "" || Convert.ToDecimal(grdSupplierList.Rows[i].Cells["clmMRP"].Value) == 0) && varProConditionType != "226")
                                        {
                                            varcount++; varCount2++;
                                        ...
                                        if ((Convert.ToString(grdSupplierList.Rows[i].Cells["clmProductMrp"].Value) == "" || Convert.ToDecimal(grdSupplierList.Rows[i].Cells["clmProductMrp"].Value) == 0) && varProConditionType != "226")
                                        {
                                            varcount++; varCount2++;
                            ...
                            if(Convert.ToString(grdSupplierList.Rows[i].Cells["clmPendingQty"].Value)!="" || Convert.ToDecimal(grdSupplierList.Rows[i].Cells["clmPendingQty"].Value) != 0)
                            {  varPendingQty = Convert.ToDecimal(grdSupplierList.Rows[i].Cells["clmPendingQty"].Value);  }
                            ...
                            if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmDamageQty"].Value) != "" || Convert.ToDecimal(grdSupplierList.Rows[i].Cells["clmDamageQty"].Value) != 0)
                            { varDamageQty = Convert.ToDecimal(grdSupplierList.Rows[i].Cells["clmDamageQty"].Value); }
                            ...
                            if (varcount == 0 && Convert.ToInt32(VarGridError) == 0)
                            {
                                ...
                                Convert.ToString(varProductExpiryDate), Convert.ToString(grdSupplierList.Rows[i].Cells["clmProductBatchNo"].Value), varCondition, varExcessQty, varPendingQty, varDamageQty);
                            }
                            if (cmbEntryType.SelectedValue.ToString() == "57") // Direct DC
                            {
        ...
        private void TxtInvoiceQty_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    errPurchaseentry.SetError(txtInvoiceQty, "Please enter quentity");
                    txtInvoiceQty.BackColor = System.Drawing.ColorTranslator.FromHtml("#fabdbd");
                    tpInvoiceQty.ShowAlways = true;
        ...
        private void CmbQtyType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                varProCondition = Convert.ToString(cmbQtyType.SelectedValue);
                ...
                //if (Convert.ToString(cmbQtyType.SelectedValue) == "226" && (varProCondition == "214" || varProCondition == "217" || varProCondition == "219"))
                //{
                //    txtMrp.Text = ""; txtMrp.Enabled = false; txtMrp.ReadOnly = true;
        ...
        private void GrdSupplierList_CellContentClick(object sender, DataGridViewCellEventArgs e)
       {
            ...
            try
            {
                ...
                for (int i = 0; i < grdSupplierList.Rows.Count; i++)
                {
                    if (PbApprovalStsid != 70)
                    {
                        ...
                        if(Convert.ToString(grdSupplierList.Rows[i].Cells["clmConditionID"].Value) == "193")//Pending
                        {
                            grdSupplierList.Rows[i].Cells["clmExcessQty"].ReadOnly = true;
                            grdSupplierList.Rows[i].Cells["clmExcessQty"].Style.BackColor = Color.LightGray;
                            grdSupplierList.Rows[i].Cells["clmDamageQty"].ReadOnly = true;
                        ...
                        else if (Convert.ToString(grdSupplierList.Rows[i].Cells["clmConditionID"].Value) == "194")//Excess
                        {
                            grdSupplierList.Rows[i].Cells["clmPendingQty"].ReadOnly = true;
                            grdSupplierList.Rows[i].Cells["clmPendingQty"].Style.BackColor = Color.LightGray;
                            grdSupplierList.Rows[i].Cells["clmDamageQty"].ReadOnly = true;
                        ...
                        else if(Convert.ToString(grdSupplierList.Rows[i].Cells["clmConditionID"].Value) == "255")//Damage
                        {
                            grdSupplierList.Rows[i].Cells["clmExcessQty"].ReadOnly = true;
                            grdSupplierList.Rows[i].Cells["clmExcessQty"].Style.BackColor = Color.LightGray;
                            grdSupplierList.Rows[i].Cells["clmPendingQty"].ReadOnly = true;
        ...
        private void TxtProductName_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (e.KeyCode == Keys.Enter)
                    {
                        //if (Convert.ToString(cmbQtyType.SelectedValue) == "54" || Convert.ToString(cmbQtyType.SelectedValue) == "57")
                        //{
        ...
        public void udfnListviewProduct()
        {
            try
            {
                if (txtProductName.Text != "")
                {
                    ...
                    { 
                        ...
                        if (Convert.ToInt32(cmbPONo.SelectedValue) == 218) //GRN
                        {
                            ...
                            cmbQtyType.SelectedValue = Convert.ToString(DGV_FilterProduct.SelectedRows[0].Cells["Condition"].Value);
                            if(Convert.ToString(cmbQtyType.SelectedValue)=="193")//Pending
                            { txtInvoiceQty.Text =  Convert.ToString(DGV_FilterProduct.SelectedRows[0].Cells["Pending Qty"].Value); }
                            else if (Convert.ToString(cmbQtyType.SelectedValue) == "194")//Excess
                            { txtInvoiceQty.Text = Convert.ToString(DGV_FilterProduct.SelectedRows[0].Cells["Excess Qty"].Value); }
                            else if (Convert.ToString(cmbQtyType.SelectedValue) == "255")//Damage
                            { txtInvoiceQty.Text = Convert.ToString(DGV_FilterProduct.SelectedRows[0].Cells["Damage Qty"].Value); }
                            else
                    ...
                    udfnAddrowEnable();
                    if (Convert.ToString(cmbPONo.SelectedValue) != "220" && varGRNProType !="226" || varGrnType == "214") //226-GRN pro type not received
                    {
                        if (Convert.ToInt32(varBatchNo) == 73)  //disabled
                        {
                            txtBatchno.Text = "";
                ...
                //if (varPrInvFlag == "1" || Convert.ToString(cmbPONo.SelectedValue) == "220" || Convert.ToString(cmbPONo.SelectedValue) == "54" || Convert.ToString(cmbPONo.SelectedValue) == "56")
                //{
                    if (varPrInvFlag == "1" || Convert.ToString(cmbPONo.SelectedValue) == "220" || varGRNProType == "226")
                    {
                        btnAdd.Focus();
        ...
        public void udfnAddrowEnable()
        {
            try
            {
                if (Convert.ToString(cmbPONo.SelectedValue) == "220" || varGRNProType=="226" && varGrnType == "215")
                {
                    //txtBatchno.Enabled = false;
                    txtMrp.Enabled = false;
                    txtDate.Enabled = false;
