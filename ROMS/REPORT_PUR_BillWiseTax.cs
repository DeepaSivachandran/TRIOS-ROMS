    ...
    public partial class REPORT_PUR_BillWiseTax : Form
    {
        ...
        public void udfnPurchaseBillWiseReport()
        {
            try
            {
                ...
                objDs = objdserv.udfnPurHsnReport(varViewType, Convert.ToInt32(cmbSupplierType.SelectedValue), "", 0, dpFromDate.Text, dpToDate.Text, 0, 0, 0, 0, 0, 0, varSupplierId, varScheduleId, Convert.ToInt32(cmbInvType.SelectedValue), 0, 0, 0, 0, "", 0);
                ...
                if (varPrint == 1)
                {
                    ...
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_PUR_BillWise_Tax_Summary.rpt");
                    }
                    else if (Convert.ToInt32(cmbReportType.SelectedValue) == 329)
                    {
                        objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_PUR_BillWise_Tax_Details.rpt");
                    }
        ...
        private void REPORT_CP_City_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                objDataBind.BindComboBoxListSelected("DEF_MASTER", "MST_TransactionID IN (0,97) AND MSTID<>0", "MST_DisplayText,MSTID", cmbReportType, "", "MST_DisplayText", "MSTID");
