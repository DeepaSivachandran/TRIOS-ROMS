    ...
    public partial class REPORT_Pur_PO_Blocked_Products : Form
    {
        ...
        public void udfnList(int varFlag)
        {
            try
            {
                ...
                udfnPurPOBlockedProducts(varFlag);
            }
            catch (Exception ex)
            {
                objError = new DataError();
        ...
        public void udfnPurPOBlockedProducts(int varFlag)
        {
            try
            {
                string varSupplierName = "-All-", varProductName = "-All-", varGroupName = "-All-", varSubgroupName = "-All-";
                int varSupplierCode = 0, varScheduleCode = 0, varProductCode = 0, varGroupCode = 0, varSubgroupCode = 0;
