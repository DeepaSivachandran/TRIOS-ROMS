...
namespace ROMS
{
    public partial class REPORT_Unassigned_Products : Form
    {
        ...
        public void udfnUnassignedProduct(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    objBillreport.Load(Application.StartupPath + "\\Reports\\RPT_Unassigned_Products.rpt");
                    ...
                    else
                    {
                        ...
                        string varReportName = "Unassigned_Products";
