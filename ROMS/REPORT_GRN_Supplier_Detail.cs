...
namespace ROMS
{
    public partial class REPORT_GRN_Supplier_Detail : Form
    {
        ...
        public void udfnGRNSupplier(int varFlag)
        {
            try
            {
                ...
                SPDataService objdserv = new SPDataService();
                objDs = objdserv.udfnGrnListLoad(16, Convert.ToInt32(lblSupplierCode.Text), Convert.ToInt32(lblschedleCode.Text), 0, 0, dpFromDate.Text, dpToDate.Text, Convert.ToInt32(lblGRNID.Text), 0, 0, "", "",varProductId, 0, "0", "", "", 0,varGroupId,varSubgroupId, 0);
                objdserv.CloseConnection();
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "GRN_Supplier_Detail";
