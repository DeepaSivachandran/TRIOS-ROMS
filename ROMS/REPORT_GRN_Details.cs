...
namespace ROMS
{
    public partial class REPORT_GRN_Details : Form
    {
        ...
        public void udfnGRNDetails(int varFlag)
        {
            try
            {
                ...
                SPDataService objdserv = new SPDataService();
                objDs = objdserv.udfnGrnListLoad(15, Convert.ToInt32(lblSupplierCode.Text), Convert.ToInt32(lblschedleCode.Text), Convert.ToInt32(cmbConcern.SelectedValue), 0, dpFromDate.Text, dpToDate.Text, 0, Convert.ToInt32(cmbStatus.SelectedValue), Convert.ToInt32(cmbOrderType.SelectedValue), "", "", 0, 0, "0", "", "", Convert.ToInt32(cmbConditionType.SelectedValue), 0, 0,varDelayMin);
                objdserv.CloseConnection();
                ...
                if (varPrint == 1)
                {
                    ...
                    objBillreport.SetParameterValue("paraConditonType", Convert.ToString(cmbConditionType.Text));
                    ...
                    else
                    {
                        ...
                        string varReportName = "GRNDetails";
        ...
        private void REPORT_GRN_Details_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                objDataBind.BindComboBoxListSelected("DEF_Master", "MST_TransactionID IN (0,82) AND MSTID NOT IN(-1,194) ORDER BY MST_OrderID ASC", "MST_DisplayText,MSTID", cmbConditionType, "", "MST_DisplayText", "MSTID");
                objDataBind = null;
                udfnConcernLoad();
