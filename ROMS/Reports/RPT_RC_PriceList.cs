...
namespace ROMS.Reports {
    ...
    public class RPT_RC_PriceList : ReportClass {
        
        public RPT_RC_PriceList() {
        }
        
        public override string ResourceName {
            get {
                return "RPT_RC_PriceList.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "ROMS.Reports.RPT_RC_PriceList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_RC_PriceList : Component, ICachedReport {
        
        public CachedRPT_RC_PriceList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_RC_PriceList rpt = new RPT_RC_PriceList();
            rpt.Site = this.Site;
            return rpt;
        }
