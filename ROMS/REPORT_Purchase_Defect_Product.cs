...
namespace ROMS
{
    public partial class REPORT_Purchase_Defect_Product : Form
    {
        ...
        public REPORT_Purchase_Defect_Product()
        {
            InitializeComponent();
            windowControl.Initialize(tsPurchaseDefectReport, this);
        }
        ...
        public void udfnPurchaseDefect(int varFlag)
        {
            try
            {
                ...
                if (varPrint == 1)
                {
                    ...
                    else
                    {
                        ...
                        string varReportName = "Purchase_Defect_Product";
                        ...
                        if (objDs != null)
                        {
                            if (objDs.Tables.Count != 0)
                            {
                                if (objDs.Tables[0].Rows.Count != 0)
                                {
                                    ...
                                    DGV_FilterProduct.Columns["SP_Name1"].Visible = false;
        ...
        private void CmbFilter_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (Convert.ToInt32(cmbFilter.SelectedValue) == 366)
                {
