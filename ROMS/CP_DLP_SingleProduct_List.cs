...
namespace ROMS
{
    ...
    public partial class CP_DLP_SingleProduct_List : Form
    {
        ...
        public CP_DLP_SingleProduct_List()
        {
            InitializeComponent();
        ...
        private void tsbNew_Click(object sender, EventArgs e)
        {
            if (privilege.Contains("2") || Convert.ToInt32(MainForm.pbUserRoleId) == 1)
            {
                try
                {
                    MainForm.objCP_DLP_SingleProduct = new CP_DLP_SingleProduct();
                    //objMainForm.CenterEntryForm(this, MainForm.objCP_DLP_SingleProduct);
                    MainForm.objCP_DLP_SingleProduct.MdiParent = this.ParentForm;
                    MainForm main = (MainForm)this.MdiParent;
                    main.IsEntryFormOpen = true;
                    main.CurrentEntryForm = MainForm.objCP_DLP_SingleProduct_List;
                    main.CurrentParentListForm = this;
                    isRunning = false;
                    MainForm.objCP_DLP_SingleProduct.Show();
            ...
            if (privilege.Contains("3") || Convert.ToInt32(MainForm.pbUserRoleId) == 1)
            {
                try
                {
                    if (grdDirectLabelList.SelectedRows.Count > 0)
                    {
                        ...
                        MainForm.objCP_DLP_SingleProduct = new CP_DLP_SingleProduct();
                        MainForm.objCP_DLP_SingleProduct.pbLPID = Convert.ToInt32(grdDirectLabelList.SelectedRows[0].Cells["ID"].Value.ToString());
                        //objMainForm.CenterEntryForm(this, MainForm.objCP_DLP_SingleProduct);
